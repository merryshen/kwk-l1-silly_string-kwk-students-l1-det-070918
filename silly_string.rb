# puts "Fabulous"
# puts "Fabulous".upcase
# puts "IM NOT SHOUTING".downcase
# puts "supercalifragilisticexpialidocious".length
# puts "wow"+"mom"
# puts "i really like programming".capitalize
# puts "Astounding aardvarks, arguably an ancient animal, always ate apples and acorns and artichokes all around Athens, amazing!".gsub("A","Z").gsub("a","o")
